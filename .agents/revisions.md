...
| R-030 | 2026-08-12 | **Auth Supabase**: login **Google** saja (login email **dihapus** karena user **tidak** punya domain/SMTP sendiri — 11:27), **user role** (admin/operator/dll), **hanya admin yang boleh pakai perintah modifikasi aplikasi via AI provider** | Tinggi | 🔲 Baru | ⭐ **PRIORITAS #2** — dijalankan setelah R-029; K-005 dibatalkan |
