...
| R-037 | 2026-08-12 | **Halaman pendaftaran untuk user baru** — setelah login Google, user baru langsung melihat halaman pendaftaran (form mendata informasi pengguna); data yang tersedia dari Google (nama, email, avatar) di-autofill | Tinggi | 🔲 Baru | **Tambah revisi — dicatat dulu, menunggu perintah eksekusi** (aturan RULES §2) |
