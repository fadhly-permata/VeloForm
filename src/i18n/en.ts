...
export const en = {
  ...
  'auth.dbUnavailable':
    'The Supabase database is not ready yet. Run the migration in supabase/migrations and expose the logic & business schemas (Settings → API → Exposed schemas).',
  ...
  'onboard.dbUnavailable':
    'The Supabase database is not ready yet. Run the migration in supabase/migrations and expose the logic & business schemas.',
